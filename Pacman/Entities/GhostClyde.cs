    ...
    class GhostClyde : Ghost
    {
        ...
        public override int Compare(VecDir v1, VecDir v2)
        {
            ...
            else if (currMode == Mode.CHASE)
            {
                ...
                int distinTile = (int)(Math.Sqrt(Math.Pow(goal.X - pos.X, 2) + Math.Pow(goal.Y - pos.Y, 2)) / Game.TILE_SIZE);
